...
menuToggle.addEventListener("click", (e) => {
  ...
  const checkActiveClass = menuToggle.classList.contains("active");
  ...
  if (checkActiveClass) {
    ...
    animate(menu, "fadeIn", 500).then((e) => {
      elemDisplay(content, "flex");
      return animate(content, "fadeInLeft", 800);
    });
  } else {
    isScrollable(true);

    animate(content, "fadeOutLeft", 500)
      .then(() => {
        elemDisplay(content, "none");
        return animate(menu, "fadeOut", 500);
      })
      .then(() => {
        elemDisplay(menu, "");
        elemDisplay(content, "");
  ...
  window.addEventListener("resize", (e) => {
    if (window.innerWidth >= 768) {
      ...
      isScrollable(true);
    } else if (checkActiveClass && window.innerWidth <= 768) {
      elemDisplay(menuToggle, "block");
      isScrollable(false);
    } else if (!checkActiveClass) {
      isScrollable(true);
    } else {
